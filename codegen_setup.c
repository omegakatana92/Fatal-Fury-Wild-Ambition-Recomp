...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "FatalFuryWildAmbition",
    .project_root_env = "FATALFURYWILDAMBITIONRECOMP_PROJECT_ROOT",
    .build_dir_env = "FATALFURYWILDAMBITIONRECOMP_BUILD_DIR",
    .force_setup_env = "FATALFURYWILDAMBITIONRECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.01_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Fatal_Fury_Wild_Ambition_Recompiled",
    .prepare_note =
